...
<div class="page-title">
    ...
    <div class="title_right">
    	<div class="col-xs-13 col-sm-7 col-md-5 col-lg-5 form-group pull-right">
    	<!-- <div class="col-xs-13 col-sm-8 col-md-7 col-lg-5 form-group pull-right"> -->
        	<div class="input-group">
            	<span class="input-group-btn" >
            		<span>
            			<button class="btn btn-dark" type="button" id="btnBack"><span class="fa fa-backward">&nbsp;&nbsp;</span>뒤로</button>
	...
	$(document).ready(function(){
		...
		$("#ItemStatus").change(function(){
 		...
 		$("#searchEMP").on("hide.bs.modal", function (e) {
 			if($("#LCode2").val()!=""){
 				getEmpInfo($("#LCode2").val());
 			}
			
		}); 
 		
 		$("#btnBack").on("click",backHwm106);
 	...
 	function popModalChek(){
 		...
 		if(($("#LCodeType").val()=="com")||($("#LCodeType").val()=="fac")||($("#LCodeType").val()=="reg")){
			...
			PNotifyAlert("error","공석처리를 할 수 없습니다.","");
 			return false;
 		}else if(($("#LCodeType").val()=="div") || ($("#LCodeType").val()=="fDiv")){
 			$("#orgListModal").modal();
 		}
 	}
 	...
 	function backHwm106(){
 		...
 		var lCodeTypeVal = $("#LCodeType").val();
 		var orgFlag = "";
 		var highOrgCode = $("#LCode1").val(); 
 		
 		if((lCodeTypeVal == "com")||(lCodeTypeVal == "etc")||(lCodeTypeVal == "empty")||(lCodeTypeVal == "div")){
 			orgFlag = "HQ";
 		}else if((lCodeTypeVal == "agen")){
 			orgFlag = "AGEN";
 		}else if((lCodeTypeVal == "fac")||(lCodeTypeVal == "fetc")||(lCodeTypeVal == "fEmpty")||(lCodeTypeVal == "fDiv")){
 			orgFlag = "FAC";
 		}else if((lCodeTypeVal == "reg")||(lCodeTypeVal == "rEmpty")){
 			orgFlag = "REG";
 		}
 		
 		console.log( "orgFlag : "  + orgFlag + " ,highOrgCode : " + highOrgCode);
 		location.href="backHwm106Paging.do?orgFlag="+orgFlag+"&highOrgCode="+highOrgCode+"&divisionName=" + $("#LCode1Name").val();
 	}
 	...
 	function moveResource(){
  	...
  	function getEmpInfo(empCode){
 		$.ajax({
 			...
 			success: function(data){
 				$("#LCode1Name").val(data.highOrgName);
 				$("#LCode1").val(data.highOrgCode);
